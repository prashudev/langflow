...
The folder _`./deploy`_ in the [Github repository](https://github.com/prashudev/langflow) contains a _`.env.example`_ file that can be used to configure a Langflow deployment.
